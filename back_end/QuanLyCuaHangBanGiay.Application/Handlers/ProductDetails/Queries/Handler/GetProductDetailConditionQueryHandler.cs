...
{
    public class GetProductDetailConditionQueryHandler : IRequestHandler<GetProductDetailByConditionQuery,
        IEnumerable<ProductDetailDto>>
    {
        private readonly IDapperHelper _dapperHelper;

        public GetProductDetailConditionQueryHandler(IDapperHelper dapperHelper)
        {
