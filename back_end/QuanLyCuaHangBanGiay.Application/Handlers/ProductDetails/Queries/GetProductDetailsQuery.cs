...
namespace Service.Handlers.ProductDetails.Queries
{
    ...
    public class
        GetAllProductDetailsQueryHandler : IRequestHandler<GetProductDetailsQuery, IEnumerable<ProductDetailDto>>
    {
        private readonly IDapperHelper _dapperHelper;

        public GetAllProductDetailsQueryHandler(IDapperHelper dapperHelper)
        {
            _dapperHelper = dapperHelper;
        }
