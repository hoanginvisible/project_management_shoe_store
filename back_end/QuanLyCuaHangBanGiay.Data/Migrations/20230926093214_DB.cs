        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEmployer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CustomerPayment = table.Column<double>(type: "float", nullable: false),
                    BankTransfer = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdProductDetail = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdBrand = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdMaterial = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdSize = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IdSale = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdProductDetail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<double>(type: "float", nullable: false),
                    ChangeAmount = table.Column<double>(type: "float", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
